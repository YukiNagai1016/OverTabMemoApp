//
//  InovationTableViewController.swift
//  NewsMemo
//
...
class InovationTableViewController: UITableViewController , IndicatorInfoProvider {
    let cellIdentifier = "postCell"
    var inovationArray = ["こんにちは"]
    //[String]()
